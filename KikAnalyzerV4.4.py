...
APP_VERSION = "4.4"  # Updated with delete keyword list feature
...
class KikAnalyzerGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.manage_tags_button.setToolTip("Add, edit, or remove custom tag labels. Pre-built tags (CSAM, Evidence, Child Notable/Age Difficult, Of Interest) cannot be removed but can be customized.")
