...
APP_VERSION = "4.1"  # Updated with delete keyword list feature
            ...
            if msg_index.isValid():
                ...
                if msg_id:
                    ...
                    if (msg_id, col) in self.parent_window.cell_borders:
                        ...
                        # Draw thick border (3-4px)
                        painter.save()
                        pen = QPen(border_color_obj, 3)  # 3px thick border
                        painter.setPen(pen)
                        rect = option.rect
...
class KikAnalyzerGUI(QMainWindow):
    ...
    def show_help(self):
        ...
        help_text_edit.setHtml(
            ...
            "</ul>"
            "<p><b>Version:</b> 4.1 | <b>GitHub:</b> <a href='https://github.com/Koebbe14/Kik-Parser'>Koebbe14/Kik-Parser</a></p>"
        )
    ...
    def show_context_menu(self, position):
        ...
        if action == add_border_action and add_border_action is not None:
            # Add borders to all selected cells without borders
            ...
            # Remove borders from all selected cells with borders
