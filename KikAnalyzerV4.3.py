...
APP_VERSION = "4.3"  # Updated with delete keyword list feature
...
class KikAnalyzerGUI(QMainWindow):
    ...
    def show_help(self):
        ...
        help_text_edit.setHtml(
            ...
            "</ul>"
            "<p><b>Version:</b> 4.3 | <b>GitHub:</b> <a href='https://github.com/Koebbe14/Kik-Parser'>Koebbe14/Kik-Parser</a></p>"
        )
